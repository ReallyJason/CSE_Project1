...
namespace eval ::optrace {
  variable script "E:/Vivado projects/CSE_Project1/project_1/project_1.runs/synth_1/component_testbench.tcl"
...
synth_design -top component_testbench -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef component_testbench.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file component_testbench_utilization_synth.rpt -pb component_testbench_utilization_synth.pb"  } 
